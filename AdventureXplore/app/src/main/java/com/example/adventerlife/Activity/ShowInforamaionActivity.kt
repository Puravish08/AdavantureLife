...
import com.example.adventerlife.Adapter.ThirdImageAdapter
...
import com.example.adventerlife.databinding.ActivityShowInforamationBinding
...
class ShowInforamaionActivity : AppCompatActivity() {
    lateinit var binding: ActivityShowInforamationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=ActivityShowInforamationBinding.inflate(layoutInflater)
    ...
    fun activityImageSlider()
    {
        ...
        firebaseDatabase.child("top").child(value).child("activity").child(key).child("viewPager").addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                thirdImageAdapter= ThirdImageAdapter(imageList,this@ShowInforamaionActivity)
