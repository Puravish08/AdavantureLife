...
import com.example.adventerlife.Activity.ShowInforamaionActivity

import java.util.Objects

class ThirdImageAdapter(
    var imageList: ArrayList<SecondImageSliderModel>,
    var showInforamaionActivity: ShowInforamaionActivity
) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        Glide.with(showInforamaionActivity).load(imageList[position].image).placeholder(R.drawable.baseline_image_24).into(imageView)
