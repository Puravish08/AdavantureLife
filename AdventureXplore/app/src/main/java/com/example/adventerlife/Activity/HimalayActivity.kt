...
class HimalayActivity : AppCompatActivity() {
    ...
    private fun initview() {
        ...
        binding.btnselectimag.setOnClickListener {
            ...
            binding.BtnAdd.setOnClickListener {
                ...
                var key = reference.root.child("HimalyTb").push().key ?: ""
                ...
                reference.root.child("HimalyTb").child(key).setValue(modelClass)
